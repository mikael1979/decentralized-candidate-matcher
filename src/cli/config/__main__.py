...
try:
    ...
    from src.cli.config.commands.list_command import list_configs  # Muutettu list -> list_configs
...
cli.add_command(list_configs, name='list')  # Käytä list_configs mutta komento on 'list'
